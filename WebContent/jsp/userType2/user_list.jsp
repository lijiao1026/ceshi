	...
	<div class="col-lg-12 col-md-12">
		<nav class="navbar navbar-default">
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="#">医生列表</a>
			</div>
			<div class="navbar-form navbar-right">
				<button type="button" class="btn btn-default" data-toggle="modal" data-target="#modal" href="<%=request.getContextPath()%>/userType2!toAdd"  >
		...
		<table class=" table table-hover table-bordered" style="text-align: center;">
			...
			<tr>
				...
				<td>
					...
					<button type="button" class="btn btn-info btn-xs" data-toggle="modal" data-target="#modal"  href="<%=request.getContextPath()%>/userType2!toDetail.action?uid=<s:property value="uid" />">查看</button>
					<button type="button" class="btn btn-warning btn-xs"  data-toggle="modal" data-target="#modal" href="<%=request.getContextPath()%>/userType2!toEdit.action?uid=<s:property value="uid" />" >修改</button>
...
<div class="col-lg-4 col-md-4 col-lg-push-5 col-md-push-5">
	<nav aria-label="Page navigation">
		<ul class="pagination  pagination-lg pagination-right">
			<li id="Previous">
				...
				<a href="${pageContext.request.contextPath}/userType2!queryList.action?currPage=<s:property value="currPage-1" />" aria-label="Previous">
	...
	<li>
		...
		<a href="${pageContext.request.contextPath}/userType2!queryList.action?currPage=<s:property value="currPage+1" />" aria-label="Next">
...
<script type="text/javascript">
	$(document).ready(function(){
		...
		for(var i=1;i<=pageTotal;i++){
			pageNo+="<li><a href={pageContext.request.contextPath}/userType2!queryList.action?currPage="+i+">"+i+"</a></li>"
		}
	...
	$("#searchStart").click(function () {
		...
		$("#searchForm").action="{pageContext.request.contextPath}/userType2!queryList.action?currPage="+currPage+"&searchUserName="+searchUserName;
		$("#searchForm").submit();
	})
	function queryList(){
		$("#searchStart").click();
