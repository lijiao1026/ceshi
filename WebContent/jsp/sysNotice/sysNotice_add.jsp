...
<div class="modal-header">
	...
	<form id="addForm" action="sysNotice!addSave.action" method="post">
		...
		<div class="modal-body">
			...
			<div class="col-md-12"  id="firstIn">
				<div class="form-group" >
					...
					<input type="text" class="form-control" maxlength="50" name="sysNotice.noticeTitle" id="enternoticetitle" placeholder="请输入公告标题">
				</div>
			</div>
			...
			<div class="col-md-12">
				<div class="form-group">
					...
					<textarea class="form-control"  maxlength="200" name="sysNotice.noticeContent" id="entersysnoticecontent" placeholder="请输入公告内容" rows="3"></textarea>
